...
def getRawData(game: str, gameSettings: dict, parameter: str):
    ...
    if game == "Captain of Industry":
        ...
        if parameter == "machineRequirements" or parameter == None:
        ...
        if parameter == "machines" or parameter == None:
            data["machines"] = {
        ...
        if parameter == "durationUnit" or parameter == None:
            data["durationUnit"] = "s"
        if parameter == "gameSettings" or parameter == None:
            data["gameSettings"] = [
                {
        ...
        if parameter == "defaultGameSettings" or parameter == None:
            data["defaultGameSettings"] = {"electricityMultiplier": 1}
        if parameter == "unitFactor" or parameter == None:
            data["unitFactor"] = 60
        if parameter == "itemUnit" or parameter == None: 
            data["itemUnit"] = "/min"
        if parameter == "itemUnitLong" or parameter == None:
            data["itemUnitLong"] = "per minute"
        if parameter == "items" or parameter == None:
            data["items"] = {
                "00": "Acid",
                "01": "Air pollution",
                "02": "Ammonia",
        ...
        if parameter == "recipes" or parameter == None:
            data["recipes"] = list()
        if parameter == "machineRequirements" or parameter == None:
            data["machineRequirements"] = list()
        if parameter == "machines" or parameter == None:
            data["machines"] = dict()
        if parameter == "durationUnit" or parameter == None:
            data["durationUnit"] = str()
        if parameter == "gameSettings" or parameter == None:
            data["gameSettings"] = list()
        if parameter == "defaultGameSettings" or parameter == None:
            data["defaultGameSettings"] = dict()
        if parameter == "unitFactor" or parameter == None:
            data["unitFactor"] = int()
        if parameter == "itemUnit" or parameter == None: 
            data["itemUnit"] = str()
        if parameter == "itemUnitLong" or parameter == None:
            data["itemUnitLong"] = str()
        if parameter == "items" or parameter == None:
            data["items"] = dict()
    if parameter == None:
        return data
...
def getData(game: str, gameSettings: dict = {}, parameter: str = None):
    ...
    def reformatRecipes(recipeList: list, items: dict[str:str], machines: dict[str:tuple]):
        recipes = []
        for index in range(len(recipeList)):
            recipe = recipeList[index]
            inputs = []
            for item in list(recipe[0].keys()):
                inputs.append({"item": items[item], "amount": recipe[0][item]})
            outputs = []
            for item in list(recipe[1].keys()):
                outputs.append({"item": items[item], "amount": recipe[1][item]})
            recipes.append(
                {
                    "inputs": inputs,
                    "outputs": outputs,
                    "duration": recipe[2],
                    "machine": machines[recipe[3]][0],
                    "id": index,
                }
            )
        return recipes
    ...
    # actually listing out the functions
    reformattingFunctions = {
        "recipes": lambda: reformatRecipes(
            getRawData(game, gameSettings, "recipes"),
            getRawData(game, gameSettings, "items"),
